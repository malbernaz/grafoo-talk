...
<img src="/img/objectmap.svg" style={{ width: "100%", padding: "1rem" }} />

---

## Integrações

No momento o Grafoo tem integrações com React e Preact. Elas expôem uma API minima para que a sua aplicação possa se conectar com a sua API GraphQL.
